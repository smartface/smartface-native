...
const TextAlignment = UI.TextAlignment;
...
describe("sf-core/ui/label Unit Test", function() {
  it("[htmlText] setter/getter with html value", function() {
    var value = "<p><a href='http://www.smartface.io'>Smartface Rocks!</a></p>";
  ...
  it("[htmlText] setter/getter with normal text", function() {
    var value = "Hello";
  ...
  it("[htmlText] should change 'text' property", function() {
