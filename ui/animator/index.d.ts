...
declare class Animator {
  constructor(params: { layout: ViewGroup; duration: number; animFn: () => void });
  perform(): Animator;
  /**
   ...
   * @since 0.1
   */
  then(duration: number, animFn: () => void): Animator;
  /**
   ...
   * @since 0.1
   */
  static animate(rootLayout: ViewGroup, duration: number, animFn: () => void): Animator;
}
export = Animator;
