...
function Page(params) {
    ...
    self.nativeObject = NativeFragment.extend("SFFragment", {
        ...
        onConfigurationChanged: function(newConfig) {
            console.log("newConfig.orientation: " + newConfig.orientation);
            _onOrientationChange && _onOrientationChange({orientation: NativeOrientationDictionary[newConfig.orientation]});
        },
