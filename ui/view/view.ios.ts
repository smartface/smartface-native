...
export default class ViewIOS<TEvent extends EventType = EventType, TNative extends { [key: string]: any } = { [key: string]: any }> extends ViewBase<TEvent> implements View<TEvent> {
