...
function SelectablePicker(params) {
  ...
  Object.defineProperties(this, {
    items: {
      ...
      set: function (items) {
        if (TypeUtil.isArray(items)) _items = items;
      },
      enumerable: true
    },
    multiSelectEnabled: {
      ...
      set: function (multiSelectEnabled) {
        if (TypeUtil.isBoolean(multiSelectEnabled) && !_isShowed) _multiSelectEnabled = multiSelectEnabled;
      },
      enumerable: true
    },
    cancelable: {
      ...
      set: function (cancelable) {
        if (TypeUtil.isBoolean(cancelable)) _cancelable = cancelable;
      },
      enumerable: true
    },
    checkedItems: {
    ...
    backgroundColor: {
      ...
      set: function (color) {
        if (color instanceof Color) _backgroundColor = color;
      },
      enumerable: true
    },
    onSelected: {
      ...
      set: function (onSelected) {
        if (TypeUtil.isFunction(onSelected)) _onSelected = onSelected;
      },
      enumerable: true
    },
    show: {
      value: function (doneCallback, cancelCallback) {
        ...
        if (_multiSelectEnabled) {
          ...
          if (_checkedItem > -1) _selectedItems[0] = _checkedItem;
    ...
    cancelButtonColor: {
      ...
      set: function (color) {
        if (color instanceof Color) _cancelButtonColor = color;
      },
      enumerable: true
    },
    cancelButtonFont: {
      ...
      set: function (font) {
        ...
        if (font instanceof Font) _cancelButtonFont = font;
      },
      enumerable: true
    },
    cancelButtonText: {
      ...
      set: function (text) {
        if (TypeUtil.isString(text)) _cancelButtonText = text;
      },
      enumerable: true
    },
    doneButtonColor: {
      ...
      set: function (color) {
        if (color instanceof Color) _doneButtonColor = color;
      },
      enumerable: true
    },
    doneButtonText: {
      ...
      set: function (text) {
        if (TypeUtil.isString(text)) _doneButtonText = text;
      },
      enumerable: true
    },
    doneButtonFont: {
      ...
      set: function (font) {
        const Font = require('../../ui/font');
        if (font instanceof Font) _doneButtonFont = font;
      },
      enumerable: true
    },
    toString: {
  ...
  Object.defineProperties(self, {
    title: {
      ...
      set: function (title) {
        if (TypeUtil.isString(title)) _title = title;
      },
      enumerable: true
    },
    titleColor: {
      ...
      set: function (color) {
        if (color instanceof Color) _titleColor = color;
      },
      enumerable: true
    },
    titleFont: {
      ...
      set: function (font) {
        const Font = require('../../ui/font');
        if (font instanceof Font) _titleFont = font;
      },
      enumerable: true
    }
  });
      ...
      _listeners['multiSelectListener'] = NativeDialogInterface.OnMultiChoiceClickListener.implement({
        onClick: function (dialogInterface, i, selected) {
          ...
          if (selected) {
            ...
            if (_selectedItems.indexOf(i) > -1) _selectedItems.splice(_selectedItems.indexOf(i), 1);
          }
        }
      });
    }
