...
declare class Image implements INativeComponent {
  ...
  ios: Partial<{
     ...
     * @since 1.1.18
     */
    resizableImageWithCapInsetsResizingMode(insets: Rectangle, mode: number): Image;
  }>;
  /**
   ...
   * @since 0.1
   */
  resize(width: number, height: number, onSuccess?: (e: { image: Image }) => void, onFailure?: (e: { message: string }) => void): Image;
  /**
   ...
   * @since 0.1
   */
  crop(x: number, y: number, width: number, height: number, onSuccess: (e: { image: Image }) => void, onFailure: (e: { message: string }) => void): Image;
  /**
   ...
   * @since 0.1
   */
  compress(format: Image.Format, quality: number, onSuccess: (e: { blob: Blob }) => void, onFailure: (e: { message: string }) => void): Blob;
  /**
   ...
   * @since 0.1
   */
  rotate(angle: number, onSuccess: (e: { image: Image }) => void, onFailure: (e: { message: string }) => void): Image;
  /**
...
export default require(`./image.${Device.deviceOS.toLowerCase()}`).default as typeof Image;
