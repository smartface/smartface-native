 ...
 */
  createSwipeItem(title: string, color: Color, padding: number, action: () => void, isAutoHide: boolean): void;
  /**
 * 
 ...
 */
  createSwipeItemWithIcon(title: string, icon: Image, color: Color, padding: number, action: () => void, isAutoHide: boolean): void;
  /**
