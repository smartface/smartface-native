...
declare namespace Color {
   ...
   * @since 0.1
   */
  function create(alpha: number, red: number, green: number, blue: number): Color;
   ...
   * @since 0.1
   */
  function createGradient(params: { direction: GradientDirection; startColor: Color; endColor: Color }): Color;
  /**
