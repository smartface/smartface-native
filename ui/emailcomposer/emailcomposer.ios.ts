...
export default class EmailComposerIOS extends NativeComponent implements AbstractEmailComposer {
  private _cc: string[];
  private _bcc: string[];
  private _to: string[];
  ...
  private _ios: Partial<{ addAttachmentForiOS(blob: Blob, mimeType?: string, fileName?: string): void }> = {};
