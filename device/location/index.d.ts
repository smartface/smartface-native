...
declare class Location {
  ...
  static android: Partial<{
     ...
     * @since 4.0.2
     */
    checkSettings(handlers: { onSuccess: () => void; onFailure: (e: { statusCode: Location.Android.SettingsStatusCodes }) => void }): void;
  }>;
  /**
  ...
  static ios: Partial<{
     ...
     * @since 2.0.11
     */
    getAuthorizationStatus(): Location.iOS.AuthorizationStatus;
    /**
