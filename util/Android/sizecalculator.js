...
Object.defineProperty(SizeCalculator, 'calculateStringSize', {
    value: function(text, maxWidth, textSize, typeface, padding) {
        let nativeTextView = new NativeTextView(context);
        ...
        nativeTextView.setTextSize(NativeTypeface.COMPLEX_UNIT_SP, textSize); //setTextSize's unit is SP by default
