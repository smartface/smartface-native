...
export const SwipeViewEvents = {
   ...
   * Click this link for SwipeToIndex and onPageScrolled use together: "https://docs.smartface.io/smartface-native-framework/ui-elements/swipeview#using-with-one-page-and-component"
   *
